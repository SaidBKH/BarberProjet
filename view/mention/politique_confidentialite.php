    ...
    <br>
    <p>1.1 Site (ci-après « le site ») : Jesuispasséchezsouf</p>
    <br>
    ...
    <p>Les données personnelles collectées sont les suivantes : nom et prénom, adresse mail, numéro de téléphone.</p>
    <br>
    ...
    <br>
    <p>Vous êtes susceptible de recevoir des offres commerciales de l’éditeur.</p>

    <p>Vos données sont susceptibles d’être utilisées par les partenaires de l’éditeur à des fins de prospection commerciale.</p>
    ...
    <br>
    <p>Pour toute question, information sur les produits présentés sur le site, ou concernant le site lui-même, vous pouvez laisser un message à l’adresse suivante : <a href="mailto:Jesuispassechezsouf@gmail.com">Jesuispassechezsouf@gmail.com</a></p>
