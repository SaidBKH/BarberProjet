...
CREATE DATABASE IF NOT EXISTS `barber` /*!40100 DEFAULT CHARACTER SET latin1 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `barber`;
...
INSERT IGNORE INTO `actualites` (`id`, `titre`, `photo`, `texte`, `date`) VALUES
...
INSERT IGNORE INTO `categories_message_contact` (`id`, `nom`) VALUES
...
INSERT IGNORE INTO `client` (`id_client`, `prenom`, `telephone`, `email`, `password`, `role`, `creationDate`) VALUES
...
INSERT IGNORE INTO `galerie` (`id_image`, `titre`, `imageUrl`, `date_creation`) VALUES
...
-- Listage des données de la table barber.reservations : ~38 rows (environ)
INSERT IGNORE INTO `reservations` (`id_reservation`, `service_id`, `client_id`, `date`, `heure`) VALUES
	...
	(35, 2, 4, '2024-05-14', '14:30:00'),
	(36, 1, 4, '2024-05-14', '09:00:00'),
	(37, 1, 4, '2024-05-14', '09:00:00'),
	(38, 1, 4, '2024-05-14', '10:00:00');
...
INSERT IGNORE INTO `service` (`id_service`, `nom`, `prix`, `duree`, `categorie_id`) VALUES
